...
from employees.views import DashboardView, ProfileUpdateView, CPasswordResetView
...
urlpatterns += i18n_patterns(
    ...
    path("accounts/password_change/", auth_views.PasswordChangeView.as_view(template_name="account/password_change.html"), name="password_change"),
    path("accounts/password_change/done/", auth_views.PasswordChangeDoneView.as_view(template_name="account/password_change_done.html"), name="password_change_done"),


    # Password reset views
    path('password_reset/', CPasswordResetView.as_view(), name='password_reset'),
